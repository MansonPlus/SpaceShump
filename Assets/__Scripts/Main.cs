...
public class Main : MonoBehaviour
{
    ...
    void Awake() {
        S = this;
        // Set bndCheck to reference the BoundsCheckl component on this GameObject
    ...
    public void SpawnEnemy() {
        ...
        // Set hte initial position for the spawned Enemy
    ...
    /// a PowerIp in place of the destroyed ship.
    /// </summary>
    /// <param name="e">The Enemy that was destroyed</param>
    static public void SHIP_DESTROYED(Enemy e) {
        // Potentially generate a PowerUp
        if (Random.value <= e.powerUpDropChance) {
            // Choose a PowerUp from the posibilities in powerUpFrequency
